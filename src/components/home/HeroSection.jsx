...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full h-[85vh] md:h-[650px] overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4">
        ...
        >
          <span className="text-xs md:text-sm font-sans font-bold text-accent tracking-[0.4em] uppercase mb-4 block">
          ...
          <p className="text-base md:text-lg text-white/70 mb-10 max-w-md mx-auto font-sans leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="w-full sm:w-auto px-10 py-5 bg-accent text-black text-xs font-bold uppercase tracking-[0.2em] rounded-lg hover:scale-105 transition-transform shadow-xl">
              Learn More
            </button>
            <button className="w-full sm:w-auto px-10 py-5 bg-white/10 backdrop-blur-md text-white border border-white/20 text-xs font-bold uppercase tracking-[0.2em] rounded-lg hover:bg-white/20 transition-all">
              Apply for Wholesale
            </button>
          </div>
        </motion.div>
